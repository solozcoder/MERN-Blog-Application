  ...
  return (
    <div className="flex w-full h-screen">
      <div className="w-full flex items-center justify-center lg:w-1/2">
        <div className=" w-11/12 max-w-[700px] px-10 py-3 rounded-3xl bg-white border-2 border-gray-100">
          <h1 className="text-[2.5rem] font-semibold">Welcome Back</h1>
      ...
      <div className="hidden relative w-1/2 h-full lg:flex items-center justify-center bg-gray-200">
        <div className="w-60 h-60 gradient-box" />
        <div className="w-full h-1/2 absolute bottom-0 bg-white/10 backdrop-blur-lg" />
        {/* <div className="w-full h-1/2 absolute bottom-0 bg-red-500" /> */}
      </div>
    </div>
  );
};
